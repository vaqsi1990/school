          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">კლასის ტესტები</h3>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-black md:text-[17px] text-[14px]">
                  შექმენით და მართეთ ტესტები თქვენი კლასებისთვის
                </p>
                <button className="mt-4 w-full cursor-pointer bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-md md:text-[20px] text-[18px] font-bold">
                  <Link href="/teacher/class-tests" className="block w-full h-full text-white">
                    ტესტების მართვა
                  </Link>
                </button>
              </div>
             ...
             <div className="bg-white overflow-hidden shadow rounded-lg">
               <div className="p-6">
                 <div className="flex items-center">
                   ...
                   <div className="ml-4">
                     <h3 className="text-lg font-medium text-gray-900">ოლიმპიადის კითხვები</h3>
                   </div>
                 </div>
                 <div className="mt-4">
