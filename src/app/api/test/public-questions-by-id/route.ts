...
export async function GET(request: NextRequest) {
  try {
    console.log('=== Public Questions by ID API Called ===')
    ...
    // Fetch all available questions for the specified subject ID and grade
    console.log('Fetching questions for:', { subjectId, grade: parseInt(grade) })
