    ...
    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex space-x-3">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="flex-1 py-2 px-4 border border-black rounded-md shadow-sm md:text-[20px] text-[18px] font-bold text-white bg-[#034e64] bg-[#034e64]  cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
