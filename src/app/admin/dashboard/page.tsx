    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Student Answers Management Card */}
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <div className="flex items-center">
                <div className="ml-4">
                  <h3 className="text-black md:text-[20px] text-[18px]">მოსწავლეთა პასუხების მართვა</h3>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-black md:text-[17px] text-[14px]">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-black md:text-[20px] text-[18px]">წესების მართვა</h3>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-black md:text-[17px] text-[14px]">
                  მართეთ წესების და პირობების გვერდი
                </p>
                <button className="mt-4 w-full cursor-pointer bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md md:text-[20px] text-[18px] font-bold">
                  <Link href="/admin/rules" className="block w-full h-full text-white">
                    წესების მართვა
                  </Link>
                </button>
              </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-black md:text-[20px] text-[18px]">კალენდრის მართვა</h3>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-black md:text-[17px] text-[14px]">
                  მართეთ კალენდრის ღონისძიებები და მოვლენები
                </p>
                <button className="mt-4 w-full cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md md:text-[20px] text-[18px] font-bold">
                  <Link href="/admin/calendar" className="block w-full h-full text-white">
                    კალენდრის მართვა
                  </Link>
                </button>
              </div>
